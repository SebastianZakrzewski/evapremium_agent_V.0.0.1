...
export class PricingIntentProfile implements IntentProfile {
  ...
  readonly instructions =
    'Wycena to jedno narzędzie quote-vehicle. Kwota tylko z jego wyniku quoted. Przy many, need_variant albo mat_type_required dopytaj. Przy none i missing_matrix_row nie wymyślaj ceny. Wycena nie jest ofertą wiążącą.';
