...
Kod: `tests/api/templates/supabase/load-catalog.spec.ts`  
...
- **Kod:** `tests/api/templates/supabase/load-catalog.spec.ts` → `it('maps shop columns onto the cascade contract')`
