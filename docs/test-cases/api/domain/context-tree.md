...
Kod: `api/src/domain/context-tree.spec.ts`  
Fixture: `api/src/context-tree/in-memory/context-tree-fixture.ts`  
...
- **Kod:** `api/src/domain/context-tree.spec.ts` → `it('returns leaf body for a known slug')`
...
- **Kod:** `api/src/domain/context-tree.spec.ts` → `it('returns a hit with empty body for seeded legal leaves')`
- **Krytyczność:** high
...
- **Kod:** `api/src/domain/context-tree.spec.ts` → `it('returns miss for an unknown slug without inventing copy')`
- **Krytyczność:** critical
...
- **Kod:** `api/src/domain/context-tree.spec.ts` → `it('returns miss for a branch slug and for an inactive leaf')`
- **Krytyczność:** high
