...
| Sentry na API | [api/observability/sentry.md](api/observability/sentry.md) | `api/src/observability/init-sentry.spec.ts`, `report-unexpected-error.spec.ts`, `sentry-debug-probe.spec.ts` |
...
| Vercel dashboard (bez proxy czatu) | [deploy/dashboard-vercel.md](deploy/dashboard-vercel.md) | `deploy/dashboard-vercel.test.mjs` |
