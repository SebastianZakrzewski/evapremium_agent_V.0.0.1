...
`container-log` zwraca blok `[intent-turn]`, blok `[drzewo]` (slugi gałęzi
i liści, pewność, trafienie lookupu) i id użytego narzędzia, bez treści
wiadomości i bez `body` liścia.
